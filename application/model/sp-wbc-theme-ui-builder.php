...
class SP_WBC_Theme_Ui_Builder extends \eo\wbc\model\SP_WBC_Ui_Builder {
	...
	// NOTE: even though almost all the implementation will be always on wbc layer class but still this class is created. only for the scenario if required to cover theme specific implementation here than we can put it. and also for the standard structure requirements.
