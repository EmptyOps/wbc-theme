...
*/
namespace sp\wbc_theme\model;
use \sp\theme\view\ui\Composer_Elements;

defined( 'ABSPATH' ) || exit;

class SP_WBC_Theme_Page_Builder extends \eo\wbc\model\SP_WBC_Page_Builder {
	...
	// NOTE:  even though almost all the implementation will be always on wbc layer class but still this class is created. only for the scenario if required to cover theme specific implementation here than we can put it. and also for the standard structure requirements. the main reason for implementing most of the flow in wbc layer class is that wbc is already supporting one page on wbc free layer so it is simply accurate idea to implement it on the wbc layer class.  
